...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('activeSkill', models.ManyToManyField(to='monsterdatabasejp.ActiveSkill')),
            ],
        ),
        migrations.CreateModel(
            name='Evolution',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('evolutions', models.ManyToManyField(to='monsterdatabasejp.Evolution')),
            ],
        ),
        migrations.AddField(
            model_name='cardjp',
            name='leaderSkill',
            field=models.ManyToManyField(to='monsterdatabasejp.LeaderSkill'),
        ),
        migrations.AddField(
            model_name='cardjp',
            name='monster',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='monster', to='monsterdatabasejp.MonsterData'),
        ),
    ]
