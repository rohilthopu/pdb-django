...
class CardNA(models.Model):
    activeSkill = models.OneToOneField(ActiveSkill, on_delete=models.CASCADE, related_name="active_skill", blank=True, null=True)
    leaderSkill = models.OneToOneField(LeaderSkill, on_delete=models.CASCADE, related_name="leader_skill", blank=True, null=True)
