...
def parse_skill_multiplier(skill, other_fields, length) -> {}:
    ...
    # Attack boost only
    elif skill in [11, 22, 26, 31, 40, 66, 69, 88, 90, 92, 94, 95, 96, 97, 100, 101, 104, 109, 122, 130, 131, 150]:
        ...
        if length == 3:
            ...
            if other_fields[-1] < other_fields[1]:
                ...
                if other_fields[0] == 63:
                    multipliers['atk'] *= get_third_last(other_fields) + (6 - other_fields[1]) * get_second_last(other_fields)
            else:
